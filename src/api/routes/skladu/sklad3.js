...
app.get("/sklad3", verifyUserToken, roleAccess(["String2", "String1"]), Sklad3.getSklad);
...
app.delete("/sklad3/:id", verifyUserToken, roleAccess(["String2", "String1"]), Sklad3.delete);
